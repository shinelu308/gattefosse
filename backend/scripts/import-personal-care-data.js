...
const blocks = [
  {
    ...
    data: {
      ...
      backgroundImage: '/sites/default/files/styles/page_banner_desktop_full/public/2023-07/40-web-shooting-gattefosse-jour3-27oct2022-saintpriest-chloelapeyssonnie-6979-1.jpgebad.jpg',
      buttons: [
        { label: '找到您要的产品', url: '/personal-care/product-finder.html' },
        { label: '查找您要的配方', url: '/personal-care/formulation-finder.html' }
      ]
    }
  },
  {
